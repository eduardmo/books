...
public class CreatePDF implements Report{
	...
	public Document create(String file, List<Book> books) {
	...
	private static void createTable(Document document, List<Book> books) throws DocumentException {
